...
<!--<li id="acomment-<?php bp_activity_comment_id(); ?>">-->
 <div class="courage_comment">
	<div class="courage_comment_user_photo">
...
<div class="courage_comment_content">
	...
	<div class="courage_comment_date">
		<?php
		/* translators: 1: user profile link, 2: user name, 3: activity permalink, 4: activity timestamp */
		printf( __( '<a href="%3$s" class="activity-time-since"><span class="time-since">%4$s</span></a>', 'buddypress' ), bp_get_activity_comment_user_link(), bp_get_activity_comment_name(), bp_get_activity_comment_permalink(), bp_get_activity_comment_date_recorded() );
		?>
	</div>
