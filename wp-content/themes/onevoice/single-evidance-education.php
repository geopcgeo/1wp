                                            ...
                                            <div class="cl_trial_info">
                                                <div class="curate_info_content">
                                                    ...
                                                    <div class="info_cont_hide">
                                                        <p><span class="highlight">Journal:</span> <?php echo $Journal= get_post_meta( $post->ID, "wpcf-journal", true );echo " "; ?></p>
                                                        <span class="highlight">DOI:</span><?php echo $doi= get_post_meta( $post->ID, "wpcf-doi-curate", true );echo " "; ?><br><br><?php
		// Start the loop.
		...
		?>
                                             ...
                                             <div class="cl_trial_info">
                                                <div class="curate_info_content">
                                                    ...
                                                    <div class="info_cont_hide">
                                                        <span class="highlight">Authors:</span><br><?php echo $doi= get_post_meta( $post->ID, "wpcf-authors", true );echo " "; ?><br>
                                       				   <div style="clsp"></div>
														<a href="<?php echo $Journal= get_post_meta( $post->ID, "wpcf-source-database", true );echo " "; ?>" target="_blank" style="width:31%;" class="button_grey">Source Database</a>
                                    					<a href="<?php echo $Journal= get_post_meta( $post->ID, "wpcf-data-source", true );echo " "; ?>" target="_blank" style="width:31%;" class="button_grey">Data Source</a> 
                                                    </div>
                                              </div>
                                             </div>
                                    	</div>
