...
if (!class_exists('LR_Core')) {
    ...
    class LR_Core {
        ...
        public function define_constants() {
            ...
            define('LR_PLUGIN_VERSION', '2.8');
            // Type of Plugin ADV, SL, SS
            define('LR_PLUGIN_PKG', 'SS');
        ...
        private function load_dependencies() {
            ...
            if ( ! get_option('LR_PLUGIN_VERSION') || ! get_option('LR_PLUGIN_PKG') ) {
        ...
        public function reset_settings($option_name) {
            ...
            <div class="lr_options_container">	
                <div class="lr-row lr-reset-body">
                    <h5><?php _e('Reset all the '.$option_name.' options to the recommended settings.', 'LoginRadius'); ?>
